...
Feature: Public Value Conversion
  ...
  Scenario Outline: Converting cty values - <TestGroup>
    ...
    And if applicable, the result should have refinements: <ExpectedRefinements>

    Examples: Primitive Conversions
      | TestGroup            | Value        | ValueType | TargetType  | ExpectedResult | ExpectedResultTypeOrError | ExpectedErrorMessage          | ExpectedRefinements |
    ...
    # Number: 1, 1.5
    # Bool: true, false
    # List: List(val1, val2) or EmptyList(ElementType) or List(Unknown(S))
    # Set: Set(val1, val2) or EmptySet(ElementType) or Set(Unknown(S))
    ...
    # Unknown: Unknown(Type) or Unknown(Type).RefineNotNull() or Unknown(Type).Refine(len_lb=X,len_ub=Y)
    # Null: Null(Type)
    # Dynamic: Dynamic
    ...
    # ExpectedRefinements describes the state of cty.Refinement (e.g., not_null, collection_length=X, etc.)
    # Some complex nested values from original tests are simplified for readability.
    # Specific GitHub issue regression tests (e.g. #23804, #21588) are covered by the general examples above.

    Examples: Unknown Value Refinements
      | TestGroup                      | Value                                  | ValueType    | TargetType   | ExpectedResult      | ExpectedResultTypeOrError | ExpectedErrorMessage | ExpectedRefinements                                          |
      | Unknown Obj to Map             | Unknown(EmptyObject)                   | Object       | Map(String)  | Unknown(Map(String))| Map(String)               |                      | collection_length=0                                        |
      | UnknownNotNull Obj to Map      | Unknown(EmptyObject).RefineNotNull()   | Object       | Map(String)  | EmptyMap(String)    | Map(String)               |                      | not_null; collection_length=0                              |
      | Unknown Obj Attrs to Map       | Unknown(Object({"a":S}))               | Object       | Map(String)  | Unknown(Map(String))| Map(String)               |                      | collection_length=1                                        |
      | UnknownNotNull Obj Attrs to Map| Unknown(Object({"a":S})).RefineNotNull() | Object       | Map(String)  | Unknown(Map(String))| Map(String)               |                      | not_null; collection_length=1                              |
      | Unknown Tuple to List          | Unknown(EmptyTuple)                    | Tuple        | List(String) | Unknown(List(String))| List(String)             |                      | collection_length=0                                        |
      | UnknownNotNull Tuple to List   | Unknown(EmptyTuple).RefineNotNull()    | Tuple        | List(String) | EmptyList(String)   | List(String)             |                      | not_null; collection_length=0                              |
      | Unknown Tuple Elms to List     | Unknown(Tuple([S]))                    | Tuple        | List(String) | Unknown(List(String))| List(String)             |                      | collection_length=1                                        |
      | UnknownNotNull Tuple Elms to List| Unknown(Tuple([S])).RefineNotNull()    | Tuple        | List(String) | List(Unknown(S))    | List(String)             |                      | not_null; collection_length=1                              |
      | Unknown Tuple to Set           | Unknown(EmptyTuple)                    | Tuple        | Set(String)  | Unknown(Set(String))| Set(String)               |                      | collection_length=0                                        |
      | UnknownNotNull Tuple to Set    | Unknown(EmptyTuple).RefineNotNull()    | Tuple        | Set(String)  | EmptySet(String)    | Set(String)               |                      | not_null; collection_length=0                              |
      | Unknown Tuple Elms to Set      | Unknown(Tuple([S]))                    | Tuple        | Set(String)  | Unknown(Set(String))| Set(String)               |                      | collection_length=1                                        |
      | UnknownNotNull Tuple Elms to Set| Unknown(Tuple([S])).RefineNotNull()    | Tuple        | Set(String)  | Set(Unknown(S))     | Set(String)               |                      | not_null; collection_length=1                              |
      | Unknown Tuple MultiElms to Set | Unknown(Tuple([S,S]))                  | Tuple        | Set(String)  | Unknown(Set(String))| Set(String)               |                      | collection_length_lower_bound=1; collection_length_upper_bound=2 |
      | UnknownNotNull Tuple MultiElms to Set | Unknown(Tuple([S,S])).RefineNotNull() | Tuple    | Set(String)  | Unknown(Set(String))| Set(String)               |                      | not_null; collection_length_lower_bound=1; collection_length_upper_bound=2 |
      | Unknown List to Set Refined  | Unknown(List(S)).Refine(len_lb=2,len_ub=4) | List(String) | Set(String)  | Unknown(Set(String))| Set(String)               |                      | collection_length_lower_bound=1; collection_length_upper_bound=4 |
      | UnknownNotNull List to Set Refined | Unknown(List(S)).RefineNotNull().Refine(len_lb=2,len_ub=4) | List(String) | Set(String) | Unknown(Set(String)) | Set(String)            |                      | not_null; collection_length_lower_bound=1; collection_length_upper_bound=4 |
      | Unknown Set to List Refined    | Unknown(Set(S)).Refine(len_lb=2,len_ub=4)   | Set(String)  | List(String)| Unknown(List(String))| List(String)            |                      | collection_length_lower_bound=2; collection_length_upper_bound=4 |
      | UnknownNotNull Set to List Refined | Unknown(Set(S)).RefineNotNull().Refine(len_lb=2,len_ub=4) | Set(String) | List(String) | Unknown(List(String)) | List(String)            |                      | not_null; collection_length_lower_bound=2; collection_length_upper_bound=4 |
      | UnknownNotNull Bool to String  | Unknown(Bool).RefineNotNull()          | Bool         | String       | Unknown(String)     | String                    |                      | not_null                                                   |
